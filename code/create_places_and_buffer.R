...
# Convert to sf object and transform CRS if necessary
places <- st_as_sf(places, coords = c("longitude", "latitude"), crs = 4326)

places <- st_buffer(places,
                            dist = 3000,
                            joinStyle = "ROUND")
...
# save results
write_csv(distance_df_1, "data/distance_between_locations.csv")
...
# save results
write_csv(places_buffer, "data/places.csv")
