...
class ViT_Win_RVSA(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0.1, hybrid_backbone=None, norm_layer=None, init_values=None, use_checkpoint=False, 
                 use_abs_pos_emb=True, use_rel_pos_bias=False, use_shared_rel_pos_bias=False,
                 out_indices=[11], interval=5, pretrained=None, restart_regression=True):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                init_values=init_values, window_size=(5, 5) if ((i + 1) % interval != 0) else self.patch_embed.patch_shape, window=((i + 1) % interval != 0), 
                restart_regression=restart_regression)
